  ...
  customOperations: {
    ...
    'config update': {
      ...
      description:
        ...
        'Use --id <group-id> and any of: --provider, --model, --effort, --image-tag, --assistant-name, --max-messages-per-prompt, --auto-compact-window, --compact-notices, --cli-scope, ' +
      ...
      handler: async (args) => {
        ...
        if (Object.keys(updates).length === 0) {
          throw new Error(
            'Nothing to update — provide at least one of: --provider, --model, --effort, --image-tag, --assistant-name, --max-messages-per-prompt, --auto-compact-window, --compact-notices, --cli-scope, --timezone',
          );
        }
