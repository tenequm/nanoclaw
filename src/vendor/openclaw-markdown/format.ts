...
import { FILE_REF_EXTENSIONS_WITH_TLD, isAutoLinkedFileRef } from './auto-linked-file-ref.js';
import { markdownToIR, type MarkdownLinkSpan, type MarkdownIR } from './ir.js';
